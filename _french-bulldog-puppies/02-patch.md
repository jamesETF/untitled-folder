---
title: Patch
description: Meet Patch, a lilac merle French Bulldog with beautifully dappled markings and blue-green eyes — bold, playful, and affectionate.
subtitle: Lilac Merle Frenchie Patch
width: full
image: /uploads/french-bulldog-puppies/patch/patch-1.webp
...
parallax: false
permalink: /french-bulldog-puppies/patch
hubspotneeded: true
chat: true
...
<!-- ═══════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════ -->
<section class="luna-hero" aria-label="Patch hero">
  <img
    src="/uploads/french-bulldog-puppies/patch/patch-1.webp"
    alt="Patch, a Lilac Merle French Bulldog puppy with dappled markings available from Ethical Frenchie"
  ...
  <div class="luna-hero__content">
    <div class="luna-hero__text">
      ...
      <h1 class="luna-hero__name">Hi, I'm Patch!</h1>
...
<div class="luna-section--compact" style="background: var(--luna-bg);">
  <div class="luna-container luna-reveal">
    <ul class="luna-pills luna-pills--scroll" aria-label="Quick details about Patch">
      ...
      <li class="luna-pill"><span class="luna-pill__icon" aria-hidden="true">&#128154;</span> Blue-Green Eyes</li>
...
<!-- ═══════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════ -->
<section class="luna-section" style="background: var(--luna-bg);" aria-label="Patch's photos">
  <div class="luna-container luna-reveal">
    <div class="luna-gallery" data-uk-lightbox="animation: slide" style="grid-template-rows: repeat(5, 1fr);">
      <a href="/uploads/french-bulldog-puppies/patch/patch-1.webp" class="luna-gallery__item" style="grid-row: 1 / -1;" data-caption="Patch - Lilac Merle French Bulldog">
        <img
          src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
          data-src="/uploads/french-bulldog-puppies/patch/patch-1.webp"
          alt="Patch the French Bulldog - Photo 1"
      ...
      <a href="/uploads/french-bulldog-puppies/patch/patch-2.webp" class="luna-gallery__item" data-caption="Patch - Lilac Merle French Bulldog">
        <img
          src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
          data-src="/uploads/french-bulldog-puppies/patch/patch-2.webp"
          alt="Patch the French Bulldog - Photo 2"
          class="luna-gallery__img"
          data-uk-img
          loading="lazy"
        >
      ...
      <a href="/uploads/french-bulldog-puppies/patch/patch-3.webp" class="luna-gallery__item" data-caption="Patch - Lilac Merle French Bulldog">
        <img
          src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
          data-src="/uploads/french-bulldog-puppies/patch/patch-3.webp"
          alt="Patch the French Bulldog - Photo 3"
          class="luna-gallery__img"
          data-uk-img
          loading="lazy"
        >
      ...
      <a href="/uploads/french-bulldog-puppies/patch/patch-4.webp" class="luna-gallery__item" data-caption="Patch - Lilac Merle French Bulldog">
        <img
          src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
          data-src="/uploads/french-bulldog-puppies/patch/patch-4.webp"
          alt="Patch the French Bulldog - Photo 4"
          class="luna-gallery__img"
          data-uk-img
          loading="lazy"
        >
      ...
      <a href="/uploads/french-bulldog-puppies/patch/patch-5.webp" class="luna-gallery__item" data-caption="Patch - Lilac Merle French Bulldog">
        <img
          src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
          data-src="/uploads/french-bulldog-puppies/patch/patch-5.webp"
          alt="Patch the French Bulldog - Photo 5"
          class="luna-gallery__img"
          data-uk-img
          loading="lazy"
        >
      ...
      <a href="/uploads/french-bulldog-puppies/patch/patch-6.webp" class="luna-gallery__item" data-caption="Patch - Lilac Merle French Bulldog">
        <img
          src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="
          data-src="/uploads/french-bulldog-puppies/patch/patch-6.webp"
          alt="Patch the French Bulldog - Photo 6"
          class="luna-gallery__img"
          data-uk-img
          loading="lazy"
        >
...
<!-- ═══════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════ -->
<section class="luna-section" style="background: var(--luna-bg-muted);" aria-label="About Patch">
  <div class="luna-container">
    <div class="luna-two-col">

      <!-- Personality Card -->
      <div class="luna-reveal">
        <span class="luna-eyebrow--accent">Meet Patch</span>
        <div class="luna-personality">
          <p class="luna-personality__quote">He was named for his markings and grew into the personality to match — the first one out of the puppy pile and the first one into your lap.</p>
          <div class="luna-personality__body">
            <p><strong>Patch</strong> takes his name from the scrappiest of the <strong>101 Dalmatians</strong> pups, and he wears it well. He's <strong>bold, endlessly playful, and completely fearless</strong> about meeting anyone new — the one who investigates the sound instead of hiding from it, then trots back to check that you saw him do it.</p>
            <p>His coat is the real showpiece: a <strong>lilac merle</strong> pattern that scatters soft, mottled dapple across his face, cheeks and chest, set against a <strong>cream chest and cream legs</strong>. His <strong>blue-green eyes</strong> are the kind merle is famous for, and they hold that color as he grows.</p>
            <p>He's <strong>bright, sturdy and affectionate</strong> — a puppy with real character and no shyness in him at all. At eight weeks he is <strong>ready to come home now</strong>, fully vet-checked and waiting on his family.</p>
          </div>
...
<!-- ═══════════════════════════════════════════════════════════
     DETAILS ACCORDION
     ═══════════════════════════════════════════════════════════ -->
<section class="luna-section" style="background: var(--luna-bg);" aria-label="Patch's details">
  <div class="luna-container luna-container--narrow">
    <div class="luna-reveal" style="text-align: center; margin-bottom: 40px;">
      ...
      <h2 class="luna-heading luna-heading--lg">Patch's Details</h2>
    </div>
    ...
    <div class="luna-accordion luna-reveal" id="luna-accordion" role="region" aria-label="Puppy details accordion">
      ...
      <div class="luna-accordion__item is-open">
        ...
        <div class="luna-accordion__body">
          <div class="luna-accordion__body-inner">
            <p>Patch has been thoroughly examined by a licensed veterinarian and comes with a clean bill of health.</p>
            <ul>
      ...
      <div class="luna-accordion__item">
        ...
        <div class="luna-accordion__body">
          <div class="luna-accordion__body-inner">
            <ul>
              <li><strong>Personality:</strong> Bold, playful, and confident — a lilac merle boy who greets everything nose-first and comes back for a cuddle straight after</li>
              <li><strong>Ideal Home:</strong> A great fit for active families, homes with children or other dogs, and anyone who wants a puppy with real personality</li>
              <li><strong>Training:</strong> Started on basic commands, crate training, and early socialization</li>
              <li><strong>Energy Level:</strong> Lively — a genuine little explorer who plays hard and then sleeps hard</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="luna-accordion__body">
          <div class="luna-accordion__body-inner">
            <ul>
              ...
              <li><strong>Deposit:</strong> Required to reserve Patch (non-refundable, transferable to future litter)</li>
...
<!-- ═══════════════════════════════════════════════════════════
     ...
     ═══════════════════════════════════════════════════════════ -->
<section class="luna-final-cta luna-section" aria-label="Apply for Patch">
  <div class="luna-container luna-container--narrow luna-reveal">
    ...
    <h2 class="luna-final-cta__heading">Reserve Patch Before He's Gone</h2>
    <p class="luna-final-cta__sub">A puppy this special won't be available long. Patch is ready to come home now — start your application today and take the first step toward bringing Patch home.</p>
...
<div class="luna-cta-bar" id="luna-cta-bar" aria-label="Quick actions">
  <button type="button" class="luna-cta-bar__btn luna-cta-bar__btn--primary" id="luna-mobile-chat" aria-label="Message us about Patch">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
    Message Us
  </button>
  <a href="tel:212-739-0182" class="luna-cta-bar__btn luna-cta-bar__btn--secondary" aria-label="Call us about Patch">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
    Call Us
  </a>
</div>
...
<script type="application/ld+json">
{
  ...
  "@type": "Product",
  "name": "Patch - Lilac Merle French Bulldog Puppy",
  "description": "Meet Patch, a lilac merle French Bulldog with beautifully dappled markings and blue-green eyes — bold, playful, and affectionate.",
  "image": [
    "https://ethicalfrenchie.com/uploads/french-bulldog-puppies/patch/patch-1.webp",
    "https://ethicalfrenchie.com/uploads/french-bulldog-puppies/patch/patch-2.webp",
    "https://ethicalfrenchie.com/uploads/french-bulldog-puppies/patch/patch-3.webp",
    "https://ethicalfrenchie.com/uploads/french-bulldog-puppies/patch/patch-4.webp",
    "https://ethicalfrenchie.com/uploads/french-bulldog-puppies/patch/patch-5.webp",
    "https://ethicalfrenchie.com/uploads/french-bulldog-puppies/patch/patch-6.webp"
  ],
  "sku": "patch-2026",
  ...
  "offers": {
    "@type": "AggregateOffer",
    "url": "https://ethicalfrenchie.com/french-bulldog-puppies/patch",
    "priceCurrency": "USD",
    "lowPrice": "4000",
    "highPrice": "5500",
    "offerCount": "1",
